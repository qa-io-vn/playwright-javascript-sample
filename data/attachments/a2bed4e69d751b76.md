...
- Name: negative_tests.spec.js >> Business Logic: Error Handling & Validations @regression >> Cart: Add and remove 1 items @sanity
- Location: src/tests/negative_tests.spec.js:36:5
