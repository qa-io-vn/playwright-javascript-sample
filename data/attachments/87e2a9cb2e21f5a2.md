...
- Name: purchase_flow.spec.js >> Business Logic: Purchase Flow @e2e >> Purchase: Complete Flow for Sauce Labs Bike Light @smoke
- Location: src/tests/purchase_flow.spec.js:16:5
...
Call log:
  - waiting for locator('[data-test="inventory-item"]').nth(1).locator('button[id^="add-to-cart"]')
