...
- Name: purchase_flow.spec.js >> Business Logic: Purchase Flow @e2e >> Purchase: Multi-item Combination - [3,4,5] @regression
- Location: src/tests/purchase_flow.spec.js:61:5
...
Call log:
  - waiting for locator('[data-test="inventory-item"]').nth(3).locator('button[id^="add-to-cart"]')
