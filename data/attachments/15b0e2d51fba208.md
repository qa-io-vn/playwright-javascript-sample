...
- Name: purchase_flow.spec.js >> Business Logic: Purchase Flow @e2e >> Purchase: Complete Flow for Sauce Labs Onesie @smoke
...
Call log:
  - waiting for locator('[data-test="inventory-item"]').nth(4).locator('button[id^="add-to-cart"]')
