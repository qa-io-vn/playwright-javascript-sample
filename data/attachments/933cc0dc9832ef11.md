...
- Name: purchase_flow.spec.js >> Business Logic: Purchase Flow @e2e >> Purchase: Complete Flow for Sauce Labs Bolt T-Shirt @smoke
...
Call log:
  - waiting for locator('[data-test="inventory-item"]').nth(2).locator('button[id^="add-to-cart"]')
