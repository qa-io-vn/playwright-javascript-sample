...
- Name: negative_tests.spec.js >> Business Logic: Error Handling & Validations @regression >> Validation: Missing fields [Case 1] - Last Name is required
- Location: src/tests/negative_tests.spec.js:22:5
...
Call log:
  - waiting for locator('[data-test="inventory-item"]').first().locator('button[id^="add-to-cart"]')
